        ...
        <tbody>
                ...
                <th  class="menu__item menu__cr" scope="row" rowspan="3">
                  Crunchy
                    ...
                    <td class="menu__item">$1.50 <img src="../images/project/taco (1).jpg" class="menu__item" alt=""></td>
                  </tr>
                  <tr>
                    <td class="menu__item">2</td>
                    <td class="menu__item">$2.50 <img src="../images/project/taco (3).jpg" class="menu__item" alt=""></td>
                  </tr>
                  <tr>
                  <td class="menu__item">3</td>
                  <td class="menu__item">$3.25 <img src="../images/project/jarritos-mexican-soda-1.jpg" class="menu__item" alt=""></td>
                </tr>
                <tr>
                ...
                <tr>
                  <td class="menu__item">2</td>
                  <td class="menu__item">$3.50 <img src="../images/project/taco (3).jpg" class="menu__item" alt=""></td>
                </tr>
                <tr>
                  <td class="menu__item">3</td>
                  <td class="menu__item">$4.50 <img src="../images/project/project pics (6).jpg" class="menu__item" alt=""></td>
                </tr>
        </tbody>
        <tfoot>
          <tr>
